...
router.post('/username', (req, res) => {
  ...
  if (!username || !/[a-zA-Z0-9-_]+/.test(username)) {
    ...
    console.log('Set username in the session ' + username);
...
router.post('/registerRequest', csrfCheck, sessionCheck, async (req, res) => {
  console.log('start registerRequest');
  ...
  try {
    ...
    console.log('before generateAttestationOptions');
    console.log('process.env.HOSTNAME = ' + process.env.HOSTNAME);
    
    const options = fido2.generateAttestationOptions({
      rpName: RP_NAME,
      rpID: 'localhost'/*process.env.HOSTNAME*/, //FIXME patch to bypass domain error SecurityError
      userID: user.id,
    ...
    console.log('after generateAttestationOptions');
    ...
    console.log('options.pubKeyCredParams.push');
    for (let param of params) {
...
router.post('/registerResponse', csrfCheck, sessionCheck, async (req, res) => {
  ...
  const expectedRPID = 'localhost'/*process.env.HOSTNAME*/; //FIXME patch to bypass domain error SecurityError
